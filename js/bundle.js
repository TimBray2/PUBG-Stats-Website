  ...
  render: function render() {
    return (
      ...
      _react2.default.createElement(
        'div',
        { style: { fontSize: "30px" }, className: 'commentBox' },
        'Enter a video ID: ',
        ...
        _react2.default.createElement('br', null),
        this.state.videoId ? _react2.default.createElement('iframe', { width: '560', height: '315', src: "https://www.youtube.com/embed/" + this.state.videoId + this.state.startTime, frameBorder: '0', allowFullscreen: true }) : ""
      )
    );
  }
});
//<iframe width="560" height="315" src="https://www.youtube.com/embed/uIS3ejRCwME?start=30" frameborder="0" allowfullscreen></iframe>
_reactDom2.default.render(_react2.default.createElement(CommentBox, null), document.getElementById('playerStatsContent'));
